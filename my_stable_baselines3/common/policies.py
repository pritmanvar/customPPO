...
from my_stable_baselines3.common.distributions import (
...
from my_stable_baselines3.common.preprocessing import get_action_dim, is_image_space, maybe_transpose, preprocess_obs
from my_stable_baselines3.common.torch_layers import (
...
from my_stable_baselines3.common.type_aliases import PyTorchObs, Schedule
from my_stable_baselines3.common.utils import get_device, is_vectorized_observation, obs_as_tensor
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _get_action_dist_from_latent(self, latent_pi: th.Tensor):
        ...
        """
        # INSTRUCTION: get prediction from the action_net
        ...
        if isinstance(self.action_dist, DiagGaussianDistribution):
            proba_dists = []
            for indx, dist in enumerate(self.log_std):
                proba_dists.append(self.action_dist.proba_distribution(mean_actions[indx], dist))
            return proba_dists
    ...
    def _predict(self, observation: PyTorchObs, deterministic: bool = False) -> th.Tensor:
        ...
        # INSTRUCTION: Get actions
        actions = th.tensor([])
        actions_list = self.get_distribution(observation)
